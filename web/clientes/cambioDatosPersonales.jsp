<%-- 
    Document   : cambioDatosPersonales
    Created on : 08-may-2018, 19:17:48
    Author     : Alberto
--%>
    ...
    <div class="sombra">
      <div class="nucleo">
        ...
        <div class="contenido">
          ...
          <form name="fCliente" id="fEditaCliente" action="EditaCliente" method="post">
            <fieldset> 
